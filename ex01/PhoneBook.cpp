...
void PhoneBook::addContact(const Contact &contact) {
  ...
  contacts[eIdx].setFirstName(contact.getFirstName());
  contacts[eIdx].setLastName(contact.getLastName());
  contacts[eIdx].setNickname(contact.getNickname());
  contacts[eIdx].setPhoneNumber(contact.getPhoneNumber());
  contacts[eIdx].setDarkestSecret(contact.getDarkestSecret());
